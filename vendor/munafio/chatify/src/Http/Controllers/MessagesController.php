...
class MessagesController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        // // Set cURL options
        // curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8000/chatify"); // URL to send the request to
    ...
    {
        // Assuming 'name' is a column you need from 'users' and 'id' is the primary key.
        $users = Message::join('users', function ($join) {
                ...
                ->select('users.id', DB::raw('MAX(users.name) as name'), DB::raw('MAX(ch_messages.created_at) as max_created_at'))
