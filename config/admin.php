...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img style="self-center justify-center display: block; height: 48px; width: 48px;" src="https://i.ibb.co/8sSwpmw/Social-Hive-transformed-bw-removebg-preview.png"> Social Hive',
